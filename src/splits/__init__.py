"""Purged/embargoed split tagging (M5, PLAN.md §7, decision 0011).
...
`diagnostics` adds the diagnostic-only `entity_holdout` / `random_kfold`
schemes (decision 0010 — leakage-gap experiment material, never arbiters).
"""
