...
FEATURES: tuple[FeatureSpec, ...] = (
    ...
    _f("revenue_up_frac_4q", "trend", "T1", "numeric", "share of adjacent-quarter revenue increases, 4q", added_in_version="1.1"),
    ...
    _f("revenue_up_frac_8q", "trend", "T2", "numeric", "share of adjacent-quarter revenue increases, 8q", added_in_version="1.1"),
    ...
    _f("revenue_up_frac_12q", "trend", "T3", "numeric", "share of adjacent-quarter revenue increases, 12q", added_in_version="1.1"),
    ...
    _f("revenue_up_frac_20q", "trend", "T5", "numeric", "share of adjacent-quarter revenue increases, 20q", added_in_version="1.1"),
    ...
    _f("tangibles_up_frac_4q", "trend", "T1", "numeric", "share of adjacent-quarter tangibles increases, 4q", added_in_version="1.1"),
    ...
    _f("tangibles_up_frac_8q", "trend", "T2", "numeric", "share of adjacent-quarter tangibles increases, 8q", added_in_version="1.1"),
    ...
    _f("tangibles_up_frac_12q", "trend", "T3", "numeric", "share of adjacent-quarter tangibles increases, 12q", added_in_version="1.1"),
    ...
    _f("tangibles_up_frac_20q", "trend", "T5", "numeric", "share of adjacent-quarter tangibles increases, 20q", added_in_version="1.1"),
    ...
    _f("ocf_up_frac_4q", "trend", "T1", "numeric", "share of adjacent-quarter ncfo increases, 4q", added_in_version="1.1"),
    ...
    _f("ocf_up_frac_8q", "trend", "T2", "numeric", "share of adjacent-quarter ncfo increases, 8q", added_in_version="1.1"),
    ...
    _f("ocf_up_frac_12q", "trend", "T3", "numeric", "share of adjacent-quarter ncfo increases, 12q", added_in_version="1.1"),
    ...
    _f("ocf_up_frac_20q", "trend", "T5", "numeric", "share of adjacent-quarter ncfo increases, 20q", added_in_version="1.1"),
    _f("ocf_positive_frac_4q", "trend", "T1", "numeric", "share of last 4 quarterly obs with ncfo > 0", added_in_version="1.1"),
    _f("ocf_positive_frac_8q", "trend", "T2", "numeric", "share of last 8 quarterly obs with ncfo > 0", added_in_version="1.1"),
    _f("ocf_positive_frac_12q", "trend", "T3", "numeric", "share of last 12 quarterly obs with ncfo > 0", added_in_version="1.1"),
    _f("ocf_positive_frac_20q", "trend", "T5", "numeric", "share of last 20 quarterly obs with ncfo > 0", added_in_version="1.1"),
    _f("fund_history_quarters", "trend", "T5", "numeric", "quarterly filings present in the 20q window", added_in_version="1.1"),
    _f("div_years_paid_10y", "trend", "T10", "numeric", "fiscal years with -ncfdiv > 0, last 10", added_in_version="1.1"),
    _f("div_streak_10y", "trend", "T10", "numeric", "consecutive paying years ending now, max 10", added_in_version="1.1"),
    _f("div_cuts_10y", "trend", "T10", "numeric", "YoY TTM dividend drops below 0.8x prior, last 10y", added_in_version="1.1"),
    _f("div_history_years_10y", "trend", "T10", "numeric", "annual dividend observations known, last 10", added_in_version="1.1"),
    # ---- solvency / distress ----------------------------------------------
