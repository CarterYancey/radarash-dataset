...
Generated 2026-07-13 by `sharadar-qa staleness` over median-kind snapshots; label stats use the 1y horizon and skip unobservable windows. Per-year bucket shares: `staleness_by_year.csv`.
